...
"""
from src import (DEFLECTIONS, PATH_DATASHEET_OUTPUT, JOINT_NAMES,
...
for sim_gap_data in gap_handler.get_list():
    sim_gap_data._scale_factor = 1
    cur_sim_gap = sim_gap_data.get_total_gap_avg() * 0.05307869684668788
